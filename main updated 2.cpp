...
//
//void printGridBinary(const std::vector<Cell>& currentPlacement, int numRows, int numCols) {
//    std::vector<std::vector<int>> grid(numRows, std::vector<int>(numCols, 1)); // Initialize grid with all cells empty (1)
//
//    // Mark occupied cells as 0
//    for (const Cell& cell : currentPlacement) {
//        grid[cell.row][cell.column] = 0;
//    }
//
//    // Print the grid in binary format
